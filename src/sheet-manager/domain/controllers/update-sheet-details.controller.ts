...
// import { DND5EUpdateCharacterDetailsRequestDTO } from '../dtos/update-sheet-details/dnd5e-character-request.dto';

// @UseGuards(AuthGuard)
// @Controller('sheets/update-sheet/:sheetId/details')
...
//     @Body() requestData: DND5EUpdateCharacterDetailsRequestDTO,
//   ) {
